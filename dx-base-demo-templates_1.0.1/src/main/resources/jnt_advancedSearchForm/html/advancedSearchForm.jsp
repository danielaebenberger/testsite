                ...
                <div class="col-md-4">
                    ...
                    <fieldset>
                        ...
                        <div class="control-group"
                      	...
                      	<div class="control-group" id="search-order-criteria">
                      	...
                      	<div class="control-group" id="search-category-criteria">                    
                     	 	  <label class="control-label" for="searchCategory">Category
                              </label>
                     	
                              <div class="controls">
                              		<s:nodeProperty id="searchCategory" nodeType="jmix:categorized" name="j:defaultCategory" display="true" includeChildren="true" displayIncludeChildren="true"/>
                              </div>
                      	</div> 
                      
                      	<div class="control-group" id="search-zipCode-criteria">   
                        	<label class="control-label" for="searchZipCode">ZIP Code
                             </label>
                          
                          	<div class="controls">
                              		<s:nodeProperty id="searchZipCode" nodeType="jmix:locationAware" name="j:zipCode" display="true"/>
                            </div>
                      	</div> 
